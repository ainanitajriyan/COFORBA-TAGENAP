...
class CreateTDaftarSembuh extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('t_daftar_sembuh', function (Blueprint $table) {
          $table->increments('id');
          ...
          $table->enum('status',['sembuh','isolasi']);
    ...
    {
        Schema::dropIfExists('t_daftar_sembuh');
    }
}

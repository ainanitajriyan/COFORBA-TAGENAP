...
class CreateTDaftarPdp extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('t_daftar_pdp', function (Blueprint $table) {
          $table->increments('id');
          ...
          $table->enum('status_pengawasan',['rawat_jalan','rawat_inap']);
    ...
    {
        Schema::dropIfExists('t_daftar_pdp');
    }
}
